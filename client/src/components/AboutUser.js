      ...
      <div className="aboutjive">
        <div className="aboutcontainer">
          ...
          <div className="aboutcontainer-body">
            ...
            <p>
              We provide our community of users with fun and ever changing ways to explore the
              cities around them. By suggesting activities, restaurants, and events, Jive provides
              the spontaneity and variety that is often missing in our lives. Our platform reaches
              out into a vast repository of data about the community around you, and retrieves
              suggestions of exciting ways to spend your leisure time. Never again will you find
              yourself in the position of not being able to think of something to do because Jive
              will always have the answer for you!
            </p>
          </div>
