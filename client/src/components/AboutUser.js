      ...
      <div className="aboutjive">
        <div className="aboutcontainer">
          ...
          <div className="aboutcontainer-footer-icons">
            <a href="https://www.facebook.com/nick.stamos.5851?ref=br_rs" target="_blank"><FontAwesomeIcon icon={faFacebook} /></a>
            <a href="https://twitter.com/thejivenation" target="_blank"><FontAwesomeIcon icon={faTwitter} /></a>
          </div>
        </div>
      </div>
    );
